...
![alt text](../src/03-01-01-machine-learning-category-table.png)
...
线性回归的目标是找到一个最佳的线性方程：
![alt text](src/03-01-equation-image.png)
...
![alt text](src/Linear_regression.svg.png)
...
通常使用 Sigmoid 函数：
![alt text](src/03-03-equation2-image.png)
使用逻辑回归进行二分类任务:
实例
```python
...
输出的图如下所示：
![alt text](src/03-04-ml-algorithms-image.png)
...
![alt text](src/03-05-machine-learning-algorithm-category-images.png)
